...
s32 EchoVoidPackMsg(SDK_8583_ST8583 *pstIsoMsgSend, SDK_8583_ST8583 *pstIsoMsgRecv)
{
#ifndef JEFF_DEBUG
	return 0;
#else
	...
	iRet = DbgEchoHandleField39AndField54(TRANSID_VOID,pstIsoMsgSend,ucField39,NULL);
	if(iRet < 0){
		return iRet;
	}
